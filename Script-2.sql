...
CREATE TABLE complemento (
	...
	CONSTRAINT uk_com_nome UNIQUE (nome)
);
...
CREATE TABLE bairro (
	...
	CONSTRAINT uk_bairr_nome UNIQUE (nome)
);
...
ALTER TABLE municipio ADD CONSTRAINT fk_mun_ufid FOREIGN KEY (iduf) REFERENCES uf (iduf);
